...
[
    ...
    # AC_DEFINE([THOR_PACKAGE_NAME], [$1], [Name of package for header files])
    # AC_SUBST([THOR_PACKAGE_NAME], [$1])
])
...
# Note
# Bad indentation because of here document
...
[
    ...
    AS_IF(
        ...
        [
            ...
            AC_DEFINE([HAVE_MagicEnumHeaderOnlyV1], 1, [Magic Enum V1 being used])
        ],
        [
            ...
            AS_IF(
                ...
                [
                    ...
                    AC_DEFINE([HAVE_MagicEnumHeaderOnlyV2], 1, [Magic Enum V2 being used])
                ],
                []
            )
        ]
