# =============================================================================
# targets/doc.mk — documentation generation via `andvari`
#
# Designed to work with `andvari` and the theme `andvari-theme-documentation`:
...
#
#   > andvari init docSource --dest docs -t "My Project" -d "Some Text" \
#         --themeRepo git@github.com:Loki-Astari/andvari-theme-documentation.git \
...
#           Wait 15 minutes for github to get all the auto publishing correct.
#
...
#   @return
#
#   The above tags will add information about class/method/functions/param/return
...
#       }
#
#   This will create the documentation for "BaseSocket" using the comments
#   between @class and the class definition as the source used in the
#   documentation. It is looking for "class <name>" as the termination point.
#
#   Usage: @function
#
#       // @function
...
#   It is just looking for a function definition "<type> <name>(" as the
#   termination point.
#
#   Usage: @method
#
...
#   You can also add @param and @return markers to get more specific
...
#       Added this file into the documentation for the class "ClassName"
#       defined in "FileName".
#   docs/<FileName>.<FunctionName>
#       Added this file into the documentation for the function "FunctionName"
#       defined in "FileName".
#   docs/<FileName>.<ClassName>.<MethodName>
#       Added this file into the documentation for the Method "MethodName"
#       in the class "ClassName" defined in "FileName".
#
# =============================================================================
# Requires: BUILD_ROOT THORSANVIL_ROOT TARGET
# Defines:  DOC_* helpers
# Goals:    doc docX docprint  plus  $(DOC_DIR)/package/%.md
#           $(DOC_DIR)/class/%.md  $(DOC_DIR)/function/%.md
#           $(DOC_DIR)/method/%.md
# =============================================================================

DOC_PACKAGE_TOOL			= $(BUILD_ROOT)/tools/docgen/buildPackage
DOC_PACKAGE_SECTION_TOOL	= $(BUILD_ROOT)/tools/docgen/packageSectionList
DOC_CLASS_TOOL				= $(BUILD_ROOT)/tools/docgen/buildClass
DOC_METHOD_TOOL				= $(BUILD_ROOT)/tools/docgen/buildMethod
DOC_FUNCTION_TOOL			= $(BUILD_ROOT)/tools/docgen/buildFunction
DOC_CLASS_LIST_TOOL			= $(BUILD_ROOT)/tools/docgen/classList
DOC_METHOD_LIST_TOOL		= $(BUILD_ROOT)/tools/docgen/methodList
...
DOC_CLASS_EXPAND			= $(foreach loop, $(shell $(BUILD_ROOT)/tools/docgen/$(2)List $(1) '.*'), $(call DOC_DEST,$2,$(DOC_BASE).$(basename $(1)).$(loop)))
DOC_CLASSES					= $(foreach loop, $(DOC_CLASS_FILES), $(call DOC_CLASS_EXPAND, $(loop),class) $(call DOC_CLASS_EXPAND,$(loop),function))
DOC_CLASS_FILES				= $(shell $(BUILD_ROOT)/tools/docgen/findMarksFiles class function)

DOC_METHOD_GETCLASSMETHOD_T	= $(foreach loop, $(shell $(BUILD_ROOT)/tools/docgen/methodList $(1) $(3) $(2)), $(call DOC_DEST,method,$(DOC_BASE).$(basename $(1)).$(2).$(3).$(loop)))
...
DOC_METHOD_FILES			= $(shell $(BUILD_ROOT)/tools/docgen/findMarksFiles method)
