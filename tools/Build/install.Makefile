...
$(PREFIX_LIB)$(PREFIX_LIB_SUB)/lib%$(BUILD_EXTENSION).$(SO):		$(TARGET_MODE)/lib%$(BUILD_EXTENSION).$(SO)	| $(PREFIX_LIB)$(PREFIX_LIB_SUB).Dir
	@$(CP) $(TARGET_MODE)/lib$*$(BUILD_EXTENSION).$(SO) $(PREFIX_LIB)$(PREFIX_LIB_SUB)/lib$*$(BUILD_EXTENSION).$(SO)
	@$(ECHO) $(call paragraph, Install - $(TARGET_MODE) - lib$*$(BUILD_EXTENSION).$(SO))

$(PREFIX_LIB)$(PREFIX_LIB_SUB)/lib%$(BUILD_EXTENSION).a:			$(TARGET_MODE)/lib%$(BUILD_EXTENSION).a		| $(PREFIX_LIB)$(PREFIX_LIB_SUB).Dir
	@$(CP) $(TARGET_MODE)/lib$*$(BUILD_EXTENSION).a $(PREFIX_LIB)$(PREFIX_LIB_SUB)/lib$*$(BUILD_EXTENSION).a
...
$(PREFIX_DEFER_LIB)/libUnitTest$(DEFER_NAME)$(BUILD_EXTENSION).a:	coverage/libUnitTest$(DEFER_NAME)$(BUILD_EXTENSION).a	| $(PREFIX_DEFER_LIB).Dir
	@$(CP) coverage/libUnitTest$(DEFER_NAME)$(BUILD_EXTENSION).a $(PREFIX_DEFER_LIB)/libUnitTest$(DEFER_NAME)$(BUILD_EXTENSION).a
