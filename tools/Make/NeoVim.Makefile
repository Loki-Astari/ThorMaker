...
.clangd:
	...
	@echo "  Add:"						>> .clangd
	@echo -DDISBALE_CONTROL_CODES=1 $(CXX_STD_FLAG) -I.. -I$$(realpath $(THORSANVIL_ROOT))/build/include -I/opt/homebrew/include -I$$(realpath $(THORSANVIL_ROOT))/build/3rd/include $(LDLIBS_EXTERN_INC_LOC) $(CXX_EXTERN_HEADER_ONLY) | xargs -I^ -n1 echo "    - ^" >> .clangd
	@echo									>> .clangd
	@echo "---"								>> .clangd
	@echo 									>> .clangd
	@echo "If:"								>> .clangd
